...
const definitions = Object.freeze({
  ...
  file_too_large: [413, "The uploaded file is too large.", false],
  media_type_unsupported: [415, "The uploaded media type is unsupported.", false],
  video_invalid: [400, "The uploaded video is invalid or incomplete.", false],
  video_unsupported: [415, "The video container or codec is unsupported.", false],
  video_too_long: [413, "The video duration is outside the accepted range.", false],
  frame_extraction_failed: [422, "Usable frames could not be extracted from the video.", false],
